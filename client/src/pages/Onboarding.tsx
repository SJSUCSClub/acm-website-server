...
const PersonalInfo: React.FC<OnboardingTabProps> = ({ updatedUser, setPage, setUpdatedUser }) => {
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        onChange={(e) => {
          setUpdatedUser((prev) => (prev ? { ...prev, gradDate: e.target.value } : prev));
        }}
        required={true}
      />
      <Select
...
const Socials: React.FC<SocialsProps> = ({ updatedUser, setPage, setUpdatedUser, setComplete }) => {
  return (
    <OnboardingCard image={updatedUser.profilePic || ''} header="Connect your social profiles">
      <Input
        label="LinkedIn"
        required={false}
        ...
        onChange={(e) => {
          setUpdatedUser((prev) => (prev ? { ...prev, linkedin: e.target.value } : prev));
        }}
      />
      <Input
        label="Github"
        ...
        onChange={(e) => {
          setUpdatedUser((prev) => (prev ? { ...prev, github: e.target.value } : prev));
        }}
      />
      <Input
        ...
        onChange={(e) => {
          setUpdatedUser((prev) => (prev ? { ...prev, discord: e.target.value } : prev));
        }}
      />
      <Input
        label="Website"
        ...
        onChange={(e) => {
          setUpdatedUser((prev) => (prev ? { ...prev, website: e.target.value } : prev));
        }}
      />
