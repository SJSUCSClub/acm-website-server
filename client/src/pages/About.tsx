    ...
    <Page>
      <div className="about text-text">
        ...
        <div className="teams space-y-4">
          ...
          <p>
            We’re dedicated to making the ACM Club a place for every student.
            Our teams provide a gateway for students into new fields and
            industries. You can join any of our teams to explore your interests
            and develop new skills as a member of the club.
          </p>
          ...
          >
            <p>
              Our design squad is focused on guiding students through the
              creative aspects of technology by offering hands-on experience in
              design projects. We emphasize the principles of user interface
              (UI) and user experience (UX) design, along with the various
              design tools and methodologies adopted by professionals in the
              tech field.
            </p>
          </TextWithImage>
