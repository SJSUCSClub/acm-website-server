...
export interface IProgressMarkerProps extends React.HTMLAttributes<HTMLDivElement> {
  variant: Variant;
}

export const ProgressMarker: React.FC<IProgressMarkerProps> = ({ variant, ...props }) => {
