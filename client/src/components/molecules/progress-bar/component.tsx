...
export interface IProgressBarProps extends React.ProgressHTMLAttributes<HTMLProgressElement> {
  value: number;
}

export const ProgressBar: React.FC<IProgressBarProps> = ({ className, value, ...props }) => {
  ...
  return (
    <div className="relative w-full">
      <progress
        className={cn('flex items-center justify-center w-full h-[4px]', className)}
        {...props}
        value={value}
      />
