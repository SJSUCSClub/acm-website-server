...
export interface ISocialBtnProps extends Omit<React.ComponentProps<typeof Btn>, 'variant'> {
  href: string;
}
...
export const SocialBtn: React.FC<ISocialBtnProps> = ({ className, children, href, ...props }) => {
  return (
    <Btn
      ...
      {...props}
    >
      <a href={href} target="_blank" className="flex gap-3 no-underline font-bold">
