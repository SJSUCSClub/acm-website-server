...
export interface paths {
    ...
    "/v1/users/my/membership-status": {
        ...
        /** Check if current user is a paid club member (via Google Sheets roster) */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/events/{eventID}/companies/{companyID}": {
        ...
        /** Delete a company from an event */
        delete: {
            parameters: {
                query?: never;
                header?: never;
